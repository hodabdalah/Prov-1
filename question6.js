...
function median(arr) {
  ...
  // Kolla om arrayens längd är jämn eller udda
  const arrayLength = sortedArray.length;
  if (isEven(arrayLength)) {
    // Om längden är jämn, returnera medelvärdet av de två mittersta talen
    const middle1 = sortedArray[arrayLength / 2];
    const middle2 = sortedArray[arrayLength / 2 - 1];
    return (middle1 + middle2) / 2;
  } else {
    // Om längden är udda, returnera talet på mitten-positionen
